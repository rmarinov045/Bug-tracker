    ...
    <div className='flex flex-col'>
      <div className='bg-indigo-50 rounded-xl p-2 transform transition ease-in-out 150 min-w-full'>
        ...
        <div className='flex items-center justify-between'>
          <div className='font-bold text-sm whitespace-nowrap text-ellipsis w-2/3 overflow-hidden'><p className='flex items-center gap-2'>Creator: <img src={authorImage || defaultUserImage} title={taskAuthor} className='h-8 w-8 rounded-full' alt='Assignee' /></p></div>
