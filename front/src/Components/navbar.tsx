    ...
    return (
        <div id='navbar' className='flex-col h-full pt-2 pb-2 bg-green-500 items-center flex z-0 filter'>
            ...
            <div className='flex flex-col gap-2 pt-10 items-center w-full'>
                ...
                <NavLink to='/projects' className='cursor-pointer min-h-[3rem] mb-10 flex items-center transform transition ease-in-out 150 hover:text-white w-full'>
                ...
                <NavLink to='/completed' className='cursor-pointer min-h-[3rem] flex items-center transform transition ease-in-out 150 hover:text-white w-full'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 m-auto" viewBox="0 0 20 20" fill="currentColor">
                ...
                <NavLink to='/profile' className='cursor-pointer min-h-[3rem] flex items-center transform transition ease-in-out 150 hover:text-white w-full'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 m-auto" viewBox="0 0 20 20" fill="currentColor">
