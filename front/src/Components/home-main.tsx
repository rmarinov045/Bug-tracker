    ...
    return (
        ...
        <div className='flex h-screen w-full'>
            ...
            <Navbar />
             ...
             <div id='home-admin' className='flex h-screen w-full'>
            ...
            {addTaskFieldOpened ? <div className='absolute w-screen top-20 left-1/2 transform -translate-x-1/2 z-10'>
                    <div className='w-4/5 bg-white font-bold m-auto rounded-xl shadow-2xl min-h-fit p-2'>
                        ...
                        <div className='flex flex-col p-2 gap-2'>
                            ...
                            <div onClick={() => {
                                const dropdown :HTMLElement | null = document.getElementById('drop-down')
                                ...
                                <span className='flex items-center'>{taskType} <svg id='arrow' xmlns="http://www.w3.org/2000/svg" className="transform transition ease-in-out 150 h-6 w-6 ml-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
