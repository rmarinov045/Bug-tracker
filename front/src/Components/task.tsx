...
function Task(props: taskData, update: Function) {
  ...
  async function handleDelete(id: string) {
    ...
    dispatch(deleteTask(id)) // cannot use dispatch in async => use redux thunk
  ...
  async function handleComplete() {
    ...
    dispatch(deleteTask(id)) // deletes task from state for now => cannot use dispatch in asyns => user redux thunk
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='relative rounded-xl w-full mt-2 flex p-1 pr-2 pl-2 items-center justify-center transform transition ease-in-out 150'>
        ...
        <div className='w-1/3 min-h-fit flex justify-center bg-green-500 rounded-l-xl p-1'>
          <svg onClick={() => handleComplete()} xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 cursor-pointer transform transition ease-in-out 150 hover:text-white" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          </svg>
        </div>

        <div className='w-1/3 flex justify-center bg-orange-500 p-1'>
        ...
        <div className='w-1/3 flex justify-center bg-red-500 rounded-r-xl p-1'>
